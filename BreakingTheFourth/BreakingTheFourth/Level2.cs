        ...
        public List<Terrain> NextScreen(int screen, Bullet bullet)
        {
            ...
            {//////////////////////////////////////////////////////////////////issue on level 2 screen 1 where if you walk into the left wall you lose a life
                case 1:
                    ...
                    pieces.Add(new SpecialTerrain(200, 470, 40, 40, 200, 490, Movement.Vertical)); //moving platform
                ...
                case 2:
                    ...
                    pieces.Add(new SpecialTerrain(450, 125, 40, 40, 50, 250, Movement.Vertical));//moving platform
                ...
                case 4:
                    ...
                    pieces.Add(new Terrain(0, 450, 150, 40)); // left floor
                    pieces.Add(new Terrain(0, 0, 25, 300)); // left wall
                    pieces.Add(new SpecialTerrain(200, 440, 60, 60, 200, 440, Movement.Vertical)); //moving platform
                ...
                case 5:
                    ...
                    pieces.Add(new Terrain(0, 0, 800, 40)); //ceiling
                    pieces.Add(new SpecialTerrain(325, 90, 20, 20, 40, 120, Movement.Vertical)); //tiny moving platform
                    pieces.Add(new SpecialTerrain(450, 90, 50, 50, 40, 90, Movement.Vertical)); //bigger moving platform
