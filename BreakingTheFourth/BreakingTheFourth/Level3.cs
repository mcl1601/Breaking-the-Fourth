        ...
        public List<Terrain> NextScreen(int screen, Bullet bullet)
        {
            ...
            switch (screen)
            {
                ...
                case 4:
                    ...
                    pieces.Add(new SpecialTerrain(225, 25, 30, 200, 25, 250,"vertical"));//top left moving platform
                    pieces.Add(new SpecialTerrain(225, 275, 30, 200, 250, 475, "vertical"));//bottom left moving platform
                    pieces.Add(new SpecialTerrain(425, 25, 30, 200, 25, 250, "vertical"));//top left moving platform
                    pieces.Add(new SpecialTerrain(425, 275, 30, 200, 250, 475, "vertical"));//bottom left moving platform
                    pieces.Add(new SpecialTerrain(625, 25, 30, 200, 25, 250, "vertical"));//top left moving platform
                    pieces.Add(new SpecialTerrain(625, 275, 30, 200, 250, 475, "vertical"));//bottom left moving platform
                ...
                case 5:
                    ...
                    pieces.Add(new SpecialTerrain(300, 450, 50, 30, 400, 300, "horizontal"));//bottom sideways moving platform
                    pieces.Add(new SpecialTerrain(450, 300, 30, 50, 300, 400, "vertical"));//bottom vertical moving platform
                    ...
                    pieces.Add(new SpecialTerrain(300, 0, 20, 60, 0, 140, "vertical"));//top left moving platform
                    pieces.Add(new SpecialTerrain(400, 0, 20, 60, 0, 140, "vertical"));//top right moving platform
